...
// Placeholder function to get the Telegram username
// This should be replaced with the actual method to retrieve the Telegram username
const getTelegramUsername = () => {
  // Replace this with the actual logic to get the Telegram username
  // For now, let's use a placeholder username
  return 'TelegramUser';
};
        ...
        {showShopMessage && (
          <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-20">
            <div className="bg-white p-4 rounded-lg w-80">
              ...
              <button
                className="mt-4 bg-blue-500 text-white py-2 px-4 rounded"
                onClick={() => setShowShopMessage(false)}
              >
                Close
              </button>
            </div>
